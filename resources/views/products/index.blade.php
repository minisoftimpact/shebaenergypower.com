            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <table class="w-full table table-auto">
                    ...
                    <tbody>
                        ...
                        <tr class="*:px-3 *:py-3 hover:bg-gray-100 {{ request('product') == $product->id ? 'bg-brand-primary/15' : '' }}">
                            ...
                            <td class="text-center">
                                ...
                                <a class="px-4 text-sm py-1 rounded-lg bg-sky-500 text-white" href="{{ route('products.edit', $product->id) }}">Edit</a>
                            </td>
                        </tr>
                        @empty
                        <tr class="*:px-3 *:py-2">
